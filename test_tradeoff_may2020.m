...
ramp_capacity_up = (10+ 69.15 +4.33+3.4+2.9+3.15) * 60 * 1.5  ;
ramp_capacity_down = (10+76.93+4.33+3.4+2.9+3.15) * 60 + 1500 ;
...
% Fixed_transfer = 45000;
ramp_capacity_up = (10+ 69.15 +4.33+3.4+2.9+3.15) * 60 * 1.5  * input_capacity/30000;
